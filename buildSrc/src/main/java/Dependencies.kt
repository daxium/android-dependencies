...
object Dependencies {
    ...
    const val xAppCompat = "androidx.appcompat:appcompat:1.2.0-rc01"
    ...
    const val xCore = "androidx.core:core:1.1.0"
    ...
    const val xDatabindingAdapters = "androidx.databinding:databinding-adapters:${Version.databinding}"
    const val xDatabindingCommon = "androidx.databinding:databinding-common:${Version.databinding}"
    const val xDatabindingCompiler = "androidx.databinding:databinding-compiler:${Version.databinding}"
    const val xDatabindingRuntime = "androidx.databinding:databinding-runtime:${Version.databinding}"
    ...
    const val xFragment = "androidx.fragment:fragment-ktx:1.2.4"
    const val xFragmentTesting = "androidx.fragment:fragment-testing:1.1.0-alpha01"
    ...
    const val xMaterial = "com.google.android.material:material:1.2.0-alpha05"
    ...
    const val xRecyclerView = "androidx.recyclerview:recyclerview:1.2.0-alpha03"
    ...
    const val threeten = "org.threeten:threetenbp:${Version.threeten}"
